-- ============================================================================
-- Final Working Fix: SP_AGENT_PROFILE with No JSON in INSERT
-- ============================================================================
-- This version completely avoids JSON in INSERT statements
-- ============================================================================
...
-- Drop and recreate the procedure with no JSON in INSERT
...
def sp_agent_profile(session, stage_path, sample_size=10000, data_dictionary_ref=None, file_format='CSV_FORMAT'):
    """
    REAL Profiling agent implementation with no JSON in INSERT statements.
    """
    ...
    try:
        ...
        # Step 6: Save to database using NO JSON approach
        ...
        try:
            ...
            # Insert with NO JSON - just basic data types
            insert_query = f"""
...
SELECT 'Updated SP_AGENT_PROFILE procedure with NO JSON in INSERT!' AS STATUS;
