-- ============================================================================
-- Final Fix: SP_AGENT_PROFILE with Working Database Save
-- ============================================================================
-- This version fixes the database save issue by simplifying the approach
-- ============================================================================
...
-- Drop and recreate the procedure with working database save
...
def sp_agent_profile(session, stage_path, sample_size=10000, data_dictionary_ref=None, file_format='CSV_FORMAT'):
    """
    REAL Profiling agent implementation with working database save.
    """
    ...
    try:
        ...
        # Step 6: Save to database using direct INSERT approach
        ...
        try:
            ...
            # Also try to insert into PROFILING_RESULTS if it exists
            try:
                profiling_insert = f"""
...
SELECT 'Updated SP_AGENT_PROFILE procedure with working database save!' AS STATUS;
